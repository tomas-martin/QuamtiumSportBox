    ...
    <div className="min-h-screen bg-[#080808] flex flex-col lg:flex-row">
        ...
        <div className="relative z-10 p-12 max-w-md text-center">
          ...
          <div className="space-y-4 text-left">
            {[
              ...
              <div key={text} className="flex items-center gap-3 text-neutral-400 text-sm">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-sm relative z-10 animate-slide-up">
          ...
          {/* Card */}
          <div className="bg-neutral-900/50 backdrop-blur-xl border border-neutral-800/60 rounded-3xl p-8 shadow-2xl shadow-black/40">
            <div className="mb-8">
